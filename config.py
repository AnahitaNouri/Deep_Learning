...
class_names = ["class_candle", "class_capsules", "class_cashew", "class_chewinggum", "class_fryum", 
               "class_macaroni1", "class_macaroni2", "class_pcb1", "class_pcb2", "class_pcb3", 
               "class_pcb4", "class_pipe_fryum"]  
...
n_transforms = 8 # number of transformations per sample in training
n_transforms_test = 64 # number of transformations per sample in testing
batch_size = 80 # actual batch size is this value multiplied by n_transforms(_test)
